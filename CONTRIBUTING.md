...
1. **Fork and Clone**
   ...
   git clone https://github.com/YOUR_USERNAME/nfs-server.git
   cd nfs-server
   
   # Add upstream remote
   git remote add upstream https://github.com/rsmvdl/nfs-server.git
   ```
...
Use GitHub's [issue tracker](https://github.com/rsmvdl/nfs-server/issues) to report bugs or request features.
