...
This fork is used by `hcloud-nfs-rwx` as the one-NFS-server-per-RWX-PVC image.
The default published image is hosted publicly on GitHub Container Registry for
`github.com/rsmvdl/nfs-server`:

```text
ghcr.io/rsmvdl/nfs-server:latest
```
...
Or override the target/tag:

```bash
make push IMAGE=ghcr.io/rsmvdl/nfs-server TAG=2026-05-27
```

The GitHub Actions workflow publishes automatically to GHCR on pushes to `main`
and on version tags such as `v1.2.3`.

After the first publish, keep the GHCR package visibility set to **public** in
GitHub Packages. Kubernetes can then pull the image without `imagePullSecrets`.

Specific runtime defaults:

- NFSv4.1/NFSv4.2 only; no NFSv3/rpcbind/mountd Service ports are required for kubelet mounts using `vers=4.1`.
...
**Repository**: [https://github.com/rsmvdl/nfs-server](https://github.com/rsmvdl/nfs-server)  
**Releases**: [https://github.com/rsmvdl/nfs-server/releases](https://github.com/rsmvdl/nfs-server/releases)
...
docker run -d --name nfs-server --privileged \
  ...
  -p 2049:2049 \
  ghcr.io/rsmvdl/nfs-server:<version>
...
services:
  nfs-server:
    image: ghcr.io/rsmvdl/nfs-server:<version>
...
docker run --privileged ghcr.io/rsmvdl/nfs-server:<version>

# Alternative: Specific capabilities (may have limitations)
docker run --cap-add SYS_ADMIN --cap-add SETPCAP ghcr.io/rsmvdl/nfs-server:<version>
```
...
```bash
# Clone repository
git clone https://github.com/rsmvdl/nfs-server.git
cd nfs-server
...
- NFS Server Image Version: [e.g. ghcr.io/rsmvdl/nfs-server:latest]
...
- [GitHub Container Registry](https://github.com/rsmvdl/nfs-server/pkgs/container/nfs-server)
- [Wiki Documentation](https://github.com/rsmvdl/nfs-server/wiki)

## 🏷️ Versioning

We use [Semantic Versioning](https://semver.org/). See [releases](https://github.com/rsmvdl/nfs-server/releases) for changelog and upgrade notes.
...
### Community Support
- **GitHub Issues**: [Report bugs and request features](https://github.com/rsmvdl/nfs-server/issues)
- **Discussions**: Join our [GitHub Discussions](https://github.com/rsmvdl/nfs-server/discussions) for questions and community support
- **Documentation**: Comprehensive guides available in our [Wiki](https://github.com/rsmvdl/nfs-server/wiki)

### Resources
- **Container Registry**: [GitHub Container Registry](https://github.com/rsmvdl/nfs-server/pkgs/container/nfs-server)
- **Security Advisories**: [GitHub Security](https://github.com/rsmvdl/nfs-server/security/advisories)

### Before Reporting Issues
1. Check existing [issues](https://github.com/rsmvdl/nfs-server/issues) and [discussions](https://github.com/rsmvdl/nfs-server/discussions)
...
[![GitHub stars](https://img.shields.io/github/stars/rsmvdl/nfs-server?style=social)](https://github.com/rsmvdl/nfs-server/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/rsmvdl/nfs-server?style=social)](https://github.com/rsmvdl/nfs-server/network/members)
[![GitHub watchers](https://img.shields.io/github/watchers/rsmvdl/nfs-server?style=social)](https://github.com/rsmvdl/nfs-server/watchers)

[Container Registry](https://github.com/rsmvdl/nfs-server/pkgs/container/nfs-server) • [Contributing](CONTRIBUTING.md)
